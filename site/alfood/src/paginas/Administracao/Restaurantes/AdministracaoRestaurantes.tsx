...
const AdministracaoRestaurantes = () => {
  ...
  const excluirRestaurante = (restauranteParaExclusao: IRestaurante) => {
    httpV2.delete(`restaurantes/${restauranteParaExclusao.id}/`).then(() => {
      const listaNovosRestaurantes = restaurantes.filter(
        (restaurantes) => restaurantes.id !== restauranteParaExclusao.id
      );
